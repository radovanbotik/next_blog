...
import portrait from "../../public/images/placeholder-news.jpg";
...
export const metadata: Metadata = {
  title: "About",
  description: "My name is Rado and I do what I do",
};
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:pl-20">
          <ul role="list">
            ...
            <SocialLink href="#" icon={Messenger} className="mt-4">
              Leave message
            </SocialLink>
            <SocialLink
